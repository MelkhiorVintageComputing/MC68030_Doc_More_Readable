...
| Signal Name | Mnemonic | Input/Output | Active State | Hi-Z<br>On `HALT` | Hi-Z<br>On Bus Relinquish | Described in |
|---|:-:|:-:|:-:|:-:|:-:|:-:|
...
|---|---|---|
| §3.1 | Address Bus | `A0-A23` |
| §3.2 | Data Bus | `D0-D15` |
| §3.3 | Asynchronous Bus Control | `AS`, `R/W`, `DS`, `UDS, LDS`, `DTACK` |
| §3.4 | Bus Arbitration Control | `BR`, `BG`, `BGACK` |
| §3.5 | Interrupt Control | `IPL0, IPL1, IPL2` |
| §3.6 | System Control | `BERR`, `MODE`, `RESET`, `HALT` |
| §3.7 | M6800 Peripheral Control | `E`, `VMA`, `VPA` |
| §3.8 | Processor Function Codes | `FC0, FC1, FC2` |
| §3.9 | Clock | `CLK` |
| §3.10 | Power Supply | `VCC`, `GND` |
...
| Signal | MC68000<br>MC68HC000<br>MC68010 | MC68HC001 | MC68008<br>48-pin | MC68008<br>52-pin | MC68EC000 | Source |
|---|:-:|:-:|:-:|:-:|:-:|:-:|
| Address bus | A23–A0 | A23–A0 | A19–A0 | A21–A0 | A23–A0 | p. 3-3 |
| Data bus | D15–D0 | D15–D0<br>(D7–D0 in 8-bit mode) | D7–D0 | D7–D0 | D15–D0<br>(D7–D0 in 8-bit mode) | p. 3-4 |
| `UDS`, `LDS` | ✓ | ✓ | — | — | ✓ | p. 3-4 |
| `DS` | — | — | ✓ | ✓ | — | p. 3-5;<br>Fig. 11-4, 11-5 |
| `BGACK` | ✓ | ✓ | — | ✓ | — | pp. 3-5, 3-6;<br>Fig. 11-3, 11-4, 11-5 |
| `IPL0`, `IPL1`, `IPL2` | ✓ | ✓ | `IPL0/IPL2` and `IPL1` only | ✓ | ✓ | p. 3-6;<br>Fig. 11-4, 11-5 |
